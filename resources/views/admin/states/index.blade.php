        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-2xl font-bold mb-6">Administrar Estados</h2>
                                    ...
                                    @foreach($states as $state)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <input type="hidden" name="states[{{ $loop->index }}][id]" value="{{ $state->id }}">
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" 
                                                       name="states[{{ $loop->index }}][goal]" 
                                                       value="{{ $state->goal }}"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" 
                                                       name="states[{{ $loop->index }}][mobilized]" 
